    ...
    $(document).ready(function() 
       {
        ...
        if(readCookie('wifi-enews-signup') === null)
        {
         $('#enewsFormBlock').css('display', 'block');
        }
...
$( function emailHandler(){
    ...
    var $feedback   = $( '.wifi--form-error' );
    var $signupSuccess   = $( '.wifi--form-success' );
    ...
    function submit(){
      ...
      //var timeoutID = setTimeout(ajaxFeedback, 0);
    ...
    // Modifies internal flags
    function failure(){
          $ajaxFeedbackMessage ='Sorry, we can\'t sign you up at the moment.'
        emailValidation.message = 'Sorry, we can\'t sign you up at the moment.';
    ...
    if(!emailValidation.error)
        ...
        document.cookie = "wifi-enews-signup=true; expires= " + expires;
       }


      $("html, body").animate({scrollTop : 0},700);
       $signupSuccess.html($ajaxFeedbackMessage).addClass('success show');
         $form.addClass('hide');
          $('#enewsFormBlock').css('padding', 0);
     
             var timeoutID = setTimeout(function() { 
                       $('#enewsFormBlock').addClass('hide');
                         $signupSuccess.removeClass('show');                       
                }, 4000);
